...
export const Faqs = () => {
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-14 mb-24">
      <strong className="uppercase text-orange100 text-3xl lg:text-5xl mb-10">
        Faqs
      </strong>

      <div className="bg-darkBrown w-full py-4 md:px-12 px-6 ">
        <div className="flex justify-between items-center">
          <strong className="text-darkBlue text-base md:text-xl">
            How do I book a class?
          </strong>
          {toggleFqaOne ? (
            <img
              onClick={() => setToggleFqaOne(false)}
              className="w-[32px] md:min-w-min cursor-pointer"
              src={faqOpen}
              alt=""
            />
          ) : (
        ...
        {toggleFqaOne && (
          <div className="mt-5 md:mt-0">
            <span className="text-xs md:text-base text-justify">
              You can book onto a class using the Book a Class link at the
              bottom of this page.
            </span>
          </div>
        )}
      ...
      <div className="bg-darkBlue w-full py-4 md:px-12 px-6 ">
        <div className="flex justify-between items-center">
          <strong className="text-white text-base md:text-xl">
            Do I need to have a certain level of fitness to attend a class?
          </strong>
          {toggleFqaTwo ? (
            <img
              onClick={() => setToggleFqaTwo(false)}
              className="cursor-pointer w-[32px] md:min-w-min"
              src={faqOpen}
              alt=""
            />
          ) : (
        ...
        {toggleFqaTwo && (
          <div className="flex flex-col gap-4 mt-5 md:mt-0">
            <span className="text-xs md:text-base text-justify text-white">
      ...
      <div className="bg-darkBlue w-full py-4 md:px-12 px-6 ">
        ...
        {toggleFqaSix && (
          <div className="flex flex-col gap-4 mt-5 md:mt-0">
            <span className="text-xs md:text-base text-justify text-white text-justify ">
